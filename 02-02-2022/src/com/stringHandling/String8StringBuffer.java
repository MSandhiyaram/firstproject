...
public class String8StringBuffer 
{
	...
	public static void main(String[] args) 
	{
		...
		System.out.println(sb.indexOf("!"));//checking forward direction
		System.out.println(sb.insert(3, " User"));
		System.out.println(sb.charAt(8));
		System.out.println(sb.equals("Hey"));
		System.out.println(sb.indexOf("w", 16));//after index position of any value 
		...
		System.out.println(sb);
         ...
         //TASK:
		//  1) check whether the string is palindrome or not :(StringBuilder or StringBuffer) -completed(check 01-02-2022)
		
		// 2)how many a times a specific character is repeated in the string literal.
		//"Hello User" <-Input
		// Expected Output:
		//H->1
		//e->2 
