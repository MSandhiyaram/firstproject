...
public class String1StringMethods 
{
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("index"+str2.indexOf("d", 0));
		...
		System.out.println();
		String sample="Hey!EBIEBAmEBWorkingEBWithEBStringEBSamples";
		String arrString[]=sample.split("EB");//delimiter
